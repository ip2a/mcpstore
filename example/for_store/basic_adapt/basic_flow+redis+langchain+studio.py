...
# Redis + LangChain + Studio
# ============================================================

print("\n" + "=" * 60)
print("  MCPStore Standard Workflow Example (Redis + LangChain + Studio)")
print("=" * 60)
...
store = MCPStore.setup_store(debug=True, cache=redis_config)
...
# ============================================================
print("\n" + "=" * 60)
print("  Standard Workflow Completed (Redis + LangChain + Studio)")
print("=" * 60)
print()
