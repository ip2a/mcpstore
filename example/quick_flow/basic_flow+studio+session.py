...
# Studio Mode (STDIO Service) + Session Mode
# ============================================================

print("\n" + "=" * 60)
print("  MCPStore Standard Workflow Example (Studio + Session Mode)")
print("=" * 60)
...
with store.for_store().with_session(session_name) as session:
    ...
    # ------------------------------------------------------------
    # Step 8: Call Tool (in Session Context)
    # ------------------------------------------------------------
    print("\n[Step 8] Call Tool (in Session Context)")
...
# ============================================================
print("\n" + "=" * 60)
print("  Standard Workflow Completed (Studio + Session Mode)")
print("=" * 60)
print()
