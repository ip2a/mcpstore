...
export enum RoutesAlias {
  ...
  McpDashboard = '/mcp/views/dashboard/index', // MCP 仪表盘
  ServiceList = '/mcp/views/services/index', // 服务列表
  AddService = '/mcp/views/services/add', // 添加服务
  ToolList = '/mcp/views/tools/index', // 工具列表
  ToolExecute = '/mcp/views/tools/execute', // 工具执行器
  ConfigManager = '/mcp/views/config/index', // 配置管理
  AgentsList = '/mcp/views/agents/index', // Agent列表
