...
export enum RoutesAlias {
  ...
  McpDashboard = '/dashboard/mcp/index', // MCP 仪表盘
  ServiceList = '/services/index', // 服务列表
  AddService = '/add-service/index', // 添加服务
  ToolList = '/tools/index', // 工具列表
  ToolExecute = '/tools/execute/index', // 工具执行器
  ConfigManager = '/config-manager/index', // 配置管理
  AgentsList = '/agents/index', // Agent列表
