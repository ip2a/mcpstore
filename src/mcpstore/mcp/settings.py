...
ENV_FILE = os.getenv("MCPSTORE_ENV_FILE", ".env")
    ...
    url: Annotated[
        ...
        Field(
            description=inspect.cleandoc(
                ...
                workers via the mcpstore tasks CLI).
                """
            ),
        ),
    ] = "memory://"
...
class ExperimentalSettings(BaseSettings):
    model_config = SettingsConfigDict(
        env_prefix="MCPSTORE_EXPERIMENTAL_",
        extra="ignore",
...
class Settings(BaseSettings):
    ...
    home: Path = Path(user_data_dir("mcpstore", appauthor=False))
    ...
    client_raise_first_exceptiongroup_error: Annotated[
        ...
        Field(
            description=inspect.cleandoc(
                ...
                ExceptionGroups instead of exceptions. If this setting is True, MCPStore Clients
    ...
    show_server_banner: Annotated[
        ...
        Field(
            description=inspect.cleandoc(
                ...
                Set to False via MCPSTORE_SHOW_SERVER_BANNER=false to suppress the banner.
                """
            ),
        ),
    ] = True
    ...
    check_for_updates: Annotated[
        ...
        Field(
            description=inspect.cleandoc(
                ...
                Set via MCPSTORE_CHECK_FOR_UPDATES environment variable.
                """
            ),
        ),
    ] = "stable"
