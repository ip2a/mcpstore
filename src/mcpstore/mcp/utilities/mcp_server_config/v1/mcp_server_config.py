"""MCPStore Configuration File Support.

This module provides support for mcpstore.mcp.json configuration files that allow
...
MCPSTORE_JSON_SCHEMA = "https://gomcpstore.mcp.com/public/schemas/mcpstore.mcp.json/v1.json"
...
class MCPServerConfig(BaseModel):
    """Configuration for a MCPStore server.

    This configuration file allows you to specify all settings needed to run
    a MCPStore server in a declarative format.
    """

    # Schema field for IDE support
    schema_: str | None = Field(
        default="https://gomcpstore.mcp.com/public/schemas/mcpstore.mcp.json/v1.json",
        alias="$schema",
    ...
    def find_config(cls, start_path: Path | None = None) -> Path | None:
        """Find a mcpstore.mcp.json file in the specified directory.
        ...
        config_path = start_path / "mcpstore.mcp.json"
...
def generate_schema(output_path: Path | str | None = None) -> dict[str, Any] | None:
    """Generate JSON schema for mcpstore.mcp.json files.
    ...
    # Add some metadata
    schema["$id"] = MCPSTORE_JSON_SCHEMA
    schema["title"] = "MCPStore Configuration"
    schema["description"] = "Configuration file for MCPStore servers"
