...
async def list_skills(client: Client) -> list[SkillSummary]:
    ...
    Args:
        client: Connected MCPStore client
    ...
    Example:
        ...
        from mcpstore.mcp.utilities.skills import list_skills
...
async def download_skill(
    ...
    *,
    ...
    Example:
        ```python
        from mcpstore.mcp import Client
        from mcpstore.mcp.utilities.skills import download_skill
...
async def sync_skills(
    ...
    *,
    ...
    Example:
        ```python
        from mcpstore.mcp import Client
        from mcpstore.mcp.utilities.skills import sync_skills
