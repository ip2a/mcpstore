"""Standalone @tool decorator for MCPStore."""
...
from mcpstore.mcp.tools.function_parsing import ParsedFunction, _is_object_schema
from mcpstore.mcp.tools.tool import (
    AuthCheckCallable,
    Tool,
    ToolResult,
...
class FunctionTool(Tool):
    ...
    def from_function(
        ...
        *,
        ...
        if metadata.serializer is not None and settings.deprecation_warnings:
            warnings.warn(
        ...
        if metadata.exclude_args and settings.deprecation_warnings:
            warnings.warn(
                "The `exclude_args` parameter is deprecated as of MCPStore 2.14. "
                "Use dependency injection with `Depends()` instead for better lifecycle management. "
                "See https://gomcpstore.mcp.com/servers/dependencies for examples.",
                DeprecationWarning,
                stacklevel=2,
            )
        ...
        if self.timeout is not None:
            try:
                ...
                logger.warning(
                    ...
                    f"See https://gomcpstore.mcp.com/servers/tasks"
                )
                raise McpError(
                    ErrorData(
                        code=-32000,
    ...
    *,
    ...
    if isinstance(name_or_fn, classmethod):
        raise TypeError(
            ...
            "See https://gomcpstore.mcp.com/servers/tools#using-with-methods"
        )
