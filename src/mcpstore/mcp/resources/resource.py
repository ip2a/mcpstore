...
if TYPE_CHECKING:
    ...
    from mcpstore.mcp.resources.function_resource import FunctionResource
...
class ResourceContent(pydantic.BaseModel):
    ...
    Example:
        ```python
        from mcpstore.mcp.resources import ResourceContent
...
class Resource(MCPStoreComponent):
    ...
    def from_function(
        ...
        *,
        ...
        from mcpstore.mcp.resources.function_resource import (
            FunctionResource,
        )
    ...
    async def _read(
        ...
        For example, MCPStoreProviderResource overrides to delegate to child
    ...
    def get_span_attributes(self) -> dict[str, Any]:
        return super().get_span_attributes() | {
            "mcpstore.mcp.component.type": "resource",
...
def __getattr__(name: str) -> Any:
    ...
    if name in deprecated_exports:
        ...
        if settings.deprecation_warnings:
            warnings.warn(
                f"Importing {name} from mcpstore.mcp.resources.resource is deprecated. "
                f"Import from mcpstore.mcp.resources.function_resource instead.",
                DeprecationWarning,
                stacklevel=2,
            )
        from mcpstore.mcp.resources import function_resource
