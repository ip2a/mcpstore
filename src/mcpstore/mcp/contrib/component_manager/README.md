# Component Manager – Contrib Module for MCPStore

The **Component Manager** provides a unified API for enabling and disabling tools, resources, and prompts at runtime in a MCPStore server. This module is useful for dynamic control over which components are active, enabling advanced features like feature toggling, admin interfaces, or automation workflows.
...
- Fully integrates with MCPStore with minimal configuration.

---

## 📦 Installation

This module is part of the `mcpstore.mcp.contrib` package. No separate installation is required if you're already using **MCPStore**.
...
mcp = MCPStore(name="Component Manager", instructions="This is a test server with component manager.")
...
```python
mcp = MCPStore(name="Component Manager", instructions="This is a test server with component manager.", auth=auth)
...
mounted = MCPStore(name="Component Manager", instructions="This is a test server with component manager.", auth=auth)
...
This module is not officially maintained by the core MCPStore team. It is an independent extension developed by [gorocode](https://github.com/gorocode).
...
This module follows the license of the main [MCPStore](https://github.com/jlowin/mcpstore) project.