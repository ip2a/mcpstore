"""Provides a base mixin class and decorators for easy registration of class methods with MCPStore."""
...
from mcpstore.mcp.utilities.types import get_fn_name
...
def mcp_tool(
    ...
    if serializer is not None and settings.deprecation_warnings:
        warnings.warn(
...
class MCPMixin:
    ...
    with a MCPStore server instance using decorators.
    ...
    register them with the provided MCPStore server instance.
    """
    ...
    def register_tools(
        ...
        """Registers all methods marked with @mcp_tool with the MCPStore server.

        Args:
            mcp_server: The MCPStore server instance to register tools with.
    ...
    def register_resources(
        ...
        """Registers all methods marked with @mcp_resource with the MCPStore server.

        Args:
            mcp_server: The MCPStore server instance to register resources with.
    ...
    def register_prompts(
        ...
        """Registers all methods marked with @mcp_prompt with the MCPStore server.

        Args:
            mcp_server: The MCPStore server instance to register prompts with.
    ...
    def register_all(
        ...
        Args:
            mcp_server: The MCPStore server instance to register with.
