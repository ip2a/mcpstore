...
It allows developers to easily define classes whose methods can be registered as tools, resources, or prompts with a `MCPStore` server instance using the `register_all()`, `register_tools()`, `register_resources()`, or `register_prompts()` methods provided by the mixin.

Includes support for
Tools:
* [enable/disable](https://gomcpstore.mcp.com/servers/tools#disabling-tools)
* [annotations](https://gomcpstore.mcp.com/servers/tools#annotations-2)
* [excluded arguments](https://gomcpstore.mcp.com/servers/tools#excluding-arguments)
* [meta](https://gomcpstore.mcp.com/servers/tools#param-meta)

Prompts:
* [enable/disable](https://gomcpstore.mcp.com/servers/prompts#disabling-prompts)
* [meta](https://gomcpstore.mcp.com/servers/prompts#param-meta)

Resources:
* [enable/disable](https://gomcpstore.mcp.com/servers/resources#disabling-resources)
* [meta](https://gomcpstore.mcp.com/servers/resources#param-meta)
...
from mcpstore.mcp.contrib.mcp_mixin import MCPMixin, mcp_tool, mcp_resource, mcp_prompt
