...
class PromptDecoratorMixin:
    ...
    def add_prompt(self: LocalProvider, prompt: Prompt | Callable[..., Any]) -> Prompt:
        ...
        Accepts either a Prompt object or a decorated function with __mcpstore__ metadata.
        """
        enabled = True
        ...
        def decorate_and_register(
            ...
            if params and params[0] in ("self", "cls"):
                ...
                raise TypeError(
                    ...
                    f"    from mcpstore.mcp.prompts import prompt\n\n"
                    f"    class MyClass:\n"
                    f"        @prompt\n"
                    f"        def {fn_name}(...):\n"
                    f"            ...\n\n"
                    ...
                    f"See https://gomcpstore.mcp.com/servers/prompts#using-with-methods"
                )
