...
```python
from mcpstore.mcp.server.providers import LocalProvider
...
from mcpstore.mcp.server.providers.local_provider.decorators import (
...
_C = TypeVar("_C", bound=MCPStoreComponent)
...
class LocalProvider(
    ...
    def __init__(
        ...
        self._components: dict[str, MCPStoreComponent] = {}

    # =========================================================================
    # Storage methods
    # =========================================================================

    def _get_component_identity(self, component: MCPStoreComponent) -> tuple[type, str]:
    ...
    def _get_component(self, key: str) -> MCPStoreComponent | None:
