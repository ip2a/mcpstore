...
class MCPType(enum.Enum):
    """Type of MCPStore component to create from a route.
...
class RouteMap:
    """Mapping configuration for HTTP routes to MCPStore component types."""
    ...
    mcp_type: MCPType = field(
        metadata={"description": "The type of MCPStore component to create."},
    )
    mcp_tags: set[str] = field(
        default_factory=set,
        metadata={
            "description": "A set of tags to apply to the generated MCPStore component."
        },
    )
...
def _determine_route_type(
    ...
    """Determine the MCPStore component type based on the route and mappings."""
