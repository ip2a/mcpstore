...
Components are created using the standalone decorators from mcpstore.mcp.tools,
mcpstore.mcp.resources, and mcpstore.mcp.prompts:
...
from mcpstore.mcp.server.providers.filesystem_discovery import discover_and_import
...
class FileSystemProvider(LocalProvider):
    ...
    - @tool from mcpstore.mcp.tools
    - @resource from mcpstore.mcp.resources
    - @prompt from mcpstore.mcp.prompts
    ...
    def _register_component(self, component: MCPStoreComponent) -> None:
