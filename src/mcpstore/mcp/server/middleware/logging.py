"""Comprehensive logging middleware for MCPStore servers."""
...
class LoggingMiddleware(BaseLoggingMiddleware):
    ...
    Example:
        ```python
        from mcpstore.mcp.server.middleware.logging import LoggingMiddleware
        import logging
    ...
    def __init__(
        ...
        *,
        ...
        Args:
            logger: Logger instance to use. If None, creates a logger named 'mcpstore.mcp.requests'
            ...
            payload_serializer: Callable that converts objects to a JSON string for the
                payload. If not provided, uses MCPStore's default tool serializer.
        """
        self.logger: Logger = logger or logging.getLogger("mcpstore.mcp.middleware.logging")
...
class StructuredLoggingMiddleware(BaseLoggingMiddleware):
    ...
    Example:
        ```python
        from mcpstore.mcp.server.middleware.logging import StructuredLoggingMiddleware
        import logging
    ...
    def __init__(
        ...
        *,
        ...
        Args:
            logger: Logger instance to use. If None, creates a logger named 'mcpstore.mcp.structured'
            log_level: Log level for messages (default: INFO)
            include_payloads: Whether to include message payloads in logs
        ...
        self.logger: Logger = logger or logging.getLogger(
            "mcpstore.mcp.middleware.structured_logging"
        )
