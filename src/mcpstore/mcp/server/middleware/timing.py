...
class TimingMiddleware(Middleware):
    ...
    Example:
        ```python
        from mcpstore.mcp.server.middleware.timing import TimingMiddleware
    ...
    def __init__(
        ...
        Args:
            logger: Logger instance to use. If None, creates a logger named 'mcpstore.mcp.timing'
            log_level: Log level for timing messages (default: INFO)
        """
        self.logger = logger or logging.getLogger("mcpstore.mcp.timing")
...
class DetailedTimingMiddleware(Middleware):
    ...
    Example:
        ```python
        from mcpstore.mcp.server.middleware.timing import DetailedTimingMiddleware
        import logging
    ...
    def __init__(
        ...
        Args:
            logger: Logger instance to use. If None, creates a logger named 'mcpstore.mcp.timing.detailed'
            log_level: Log level for timing messages (default: INFO)
        """
        self.logger = logger or logging.getLogger("mcpstore.mcp.timing.detailed")
        self.log_level = log_level
