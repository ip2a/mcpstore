...
class TaskConfig:
    ...
    def validate_function(self, fn: Callable[..., Any], name: str) -> None:
        ...
        1. mcpstore[tasks] to be installed (pydocket)
        2. Async functions
        ...
        from mcpstore.mcp.server.dependencies import require_docket
        ...
        from mcpstore.mcp.utilities.types import find_kwarg_by_type
