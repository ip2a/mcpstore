...
def create_consent_html(
    ...
    server_name_escaped = html_module.escape(server_name or "MCPStore")
    ...
    help_link = """
        <div class="help-link-container">
            <span class="help-link">
                ...
                <span class="tooltip">
                    This MCPStore server requires your consent to allow a new client
                    ...
                    <a
                    href="https://gomcpstore.mcp.com/servers/auth/oauth-proxy#confused-deputy-attacks"
    ...
    content = f"""
        <div class="container">
            {create_logo(icon_url=server_icon_url, alt_text=server_name or "MCPStore")}
