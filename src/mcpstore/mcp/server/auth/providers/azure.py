...
from mcpstore.mcp.utilities.auth import decode_jwt_payload, parse_scopes
...
class AzureProvider(OAuthProxy):
        ...
        *,
        ...
        Args:
            ...
            additional_authorize_scopes: Microsoft Graph or other upstream scopes in full format.
                ...
                These scopes allow your MCPStore server to call Microsoft Graph APIs using the
    ...
    async def _extract_upstream_claims(
        ...
        """Extract claims from Azure token response to embed in MCPStore JWT.
        ...
        decoding the MCPStore JWT without needing server-side storage lookups.
        ...
        try:
            ...
            if claims:
                logger.debug(
                    "Extracted %d Azure claims for embedding in MCPStore JWT",
                    len(claims),
                )
                return claims
