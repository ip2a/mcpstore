...
from mcpstore.mcp.server.auth import AccessToken, RemoteAuthProvider, TokenVerifier
from mcpstore.mcp.server.auth.oauth_proxy import OAuthProxy
from mcpstore.mcp.server.auth.providers.jwt import JWTVerifier
from mcpstore.mcp.utilities.auth import parse_scopes
            ...
            async with httpx.AsyncClient(timeout=self.timeout_seconds) as client:
                ...
                response = await client.get(
                    ...
                    headers={
                        ...
                        "User-Agent": "MCPStore-WorkOS-OAuth",
                    },
                )
    ...
    def __init__(
        ...
        *,
        ...
        Args:
            ...
            jwt_signing_key: Secret for signing MCPStore JWT tokens (any string or bytes). If bytes are provided,
...
class AuthKitProvider(RemoteAuthProvider):
    ...
    as it allows WorkOS to handle the OAuth flow directly while MCPStore acts
    ...
    2. Configure your MCPStore server URL as a callback:
       - Add your server URL to the Redirects tab in WorkOS dashboard
       - Example: https://your-mcpstore-server.com/oauth2/callback
    ...
    Example:
        ```python
        from mcpstore.mcp.server.auth.providers.workos import AuthKitProvider
        ...
        workos_auth = AuthKitProvider(
            ...
            base_url="https://your-mcpstore-server.com",
        )

        # Use with MCPStore
        mcp = MCPStore("My App", auth=workos_auth)
        ```
    """
    ...
    def __init__(
        ...
        *,
        ...
        Args:
            ...
            base_url: Public URL of this MCPStore server
    ...
    def get_routes(
        ...
        async def oauth_authorization_server_metadata(request):
            """Forward AuthKit OAuth authorization server metadata with MCPStore customizations."""
            try:
