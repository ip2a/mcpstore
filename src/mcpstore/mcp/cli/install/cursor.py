"""Cursor integration for MCPStore install using Cyclopts."""
...
def install_cursor_workspace(
    ...
    *,
    ...
    """Install MCPStore server to workspace-specific Cursor configuration.
    ...
    env_config = UVEnvironment(
        ...
        dependencies=(with_packages or []) + ["mcpstore"],
    ...
    full_command = env_config.build_command(["mcpstore", "run", server_spec])
...
def install_cursor(
    ...
    *,
    ...
    """Install MCPStore server in Cursor.
