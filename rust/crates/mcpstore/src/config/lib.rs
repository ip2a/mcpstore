...
fn default_server_log_level_value() -> String {
    DEFAULT_SERVER_LOG_LEVEL.to_string()
}

fn default_server_url_prefix_value() -> String {
...
fn default_startup_hard_timeout() -> f64 {
    120.0
}

fn default_readiness_interval() -> f64 {
    5.0
}

fn default_readiness_success_threshold() -> i32 {
    1
}

fn default_readiness_failure_threshold() -> i32 {
    1
}
...
fn default_liveness_failure_threshold() -> i32 {
    2
}

fn default_ping_timeout_http() -> f64 {
    20.0
}

fn default_ping_timeout_sse() -> f64 {
    20.0
}

fn default_ping_timeout_stdio() -> f64 {
    40.0
}

fn default_warning_ping_timeout() -> f64 {
    30.0
}
...
fn default_window_min_calls() -> i32 {
    5
}
...
fn default_latency_p95_warn() -> f64 {
    2.0
}

fn default_latency_p99_critical() -> f64 {
    5.0
}
...
fn default_backoff_max_duration() -> f64 {
    600.0
}

fn default_half_open_max_calls() -> i32 {
    3
}

fn default_half_open_success_rate_threshold() -> f64 {
    0.6
}

fn default_reconnect_hard_timeout() -> f64 {
    900.0
}

fn default_lease_ttl() -> f64 {
    60.0
}

fn default_lease_renew_interval() -> f64 {
    20.0
}

fn default_monitoring_reconnection_seconds() -> i32 {
    60
}

fn default_monitoring_cleanup_hours() -> f64 {
    24.0
}

fn default_local_service_ping_timeout() -> i32 {
    3
}

fn default_remote_service_ping_timeout() -> i32 {
    5
}
...
fn default_response_time_history_size() -> i32 {
    10
}

fn default_standalone_heartbeat_interval_seconds() -> f64 {
    30.0
}

fn default_standalone_http_timeout_seconds() -> f64 {
    10.0
}

fn default_standalone_reconnection_interval_seconds() -> f64 {
    60.0
}

fn default_standalone_cleanup_interval_seconds() -> f64 {
    300.0
}

fn default_streamable_http_endpoint() -> String {
    "/mcp".to_string()
}

fn default_standalone_transport() -> String {
    "stdio".to_string()
}

fn default_standalone_log_level() -> String {
    "INFO".to_string()
}

fn default_standalone_log_format() -> String {
    "json".to_string()
}
